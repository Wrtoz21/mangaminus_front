...
import SelectUploadName from "./SelectUploadName";
...
export default function UploadEpisode() {
    ...
    const uploadAdmin = async e => {
        ...
        try {
            ...
            formData.append("mangaName", uploadField.mangaName)
            ...
            for (let i = 0; i < uploadPicPage.length; i++) {
                formData.append(`mangaPicPage`, uploadPicPage[i]);
            }
    ...
    console.log(errorBack?.response?.data)
    return <div className="bg-slate-400 border border-black flex gap-2 text-xl p-2" >
        <form
            ...
            <div className="flex flex-col p-3 gap-4">
                <SelectUploadName uploadField={uploadField}
                    setUploadField={setUploadField} manga={manga} />
                ...
                <button type="submit"
                    ...
                    {loading && <div
                        ...
                        role="status" className="p-2 flex gap-2">
